...
1) Click on the search(on the top of the turboc++)
2) Click replace
3) Enter TURBOC3 in the TEXT TO FIND field
4) Enter your version of TurboC e.g TC 

The password of admin panel is admin123, and username is admin